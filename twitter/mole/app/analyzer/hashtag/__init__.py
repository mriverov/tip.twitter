...
def import_hashtags(tweets_hashtags):
    not_process = 0
...
if __name__ == '__main__':
    ...
    import_hashtags(tweets_hashtags)
    logger.info("Finish tweet")

    logger.info("Start streaming")
    stream_hashtags = db.stream.find({"entities.hashtags": {'$exists': True, '$not': {'$size': 0}}})
    import_hashtags(stream_hashtags)
